...
object JsonUtils {
  implicit val clientRequestReads: Reads[ClientRequest] = (
  ...
  implicit val driverReads: Reads[Driver]  = (
    (JsPath \ "idno").read[Long] and
  ...
  implicit val clientRequestWrites: Writes[ClientRequest] = (
  ...
  implicit val driverWrites: Writes[Driver] = (
    (JsPath \ "idno").write[Long] and
